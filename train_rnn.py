...
# How to use
# For training:
# python train_rnn.py --mode=train --checkpoint_dir=folkrnn_ONeills_datav2_100_lr0.003_O --sampling_probability=0.0

# For sampling
# python train_rnn.py --mode=sample --n_samples=1000 --output_file=mysamples_0 --checkpoint_dir=folkrnn_ONeills_datav2_100_lr0.003_O