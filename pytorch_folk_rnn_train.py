...
# How to use
# For training:
# python pytorch_folk_rnn_train.py --mode=train --checkpoint_dir=RMSProp_all_data_train --sampling_probability=0.0
 
# For sampling
# python pytorch_folk_rnn_train.py --mode=sample --n_samples=1000 --output_file=basic_samples_50 --checkpoint_dir=RMSProp_all_data_train_50_O_Sample
